...
const WarehouseManagerProfile = ({openSnackbar}) => {
    ...
    const updateWarehouseManagerProfile = async () => {
        try {
            if (ValidationService.validateMiddleName(middleName)) {
                await APIService.updateWarehouseManager(accessToken, user.id, middleName);
                    ...
                    <Grid className={classes.profileContainer}>
                        {!edit ? (
                            ...
                            <Grid container direction={"column"} className={classes.root}>
                                ...
                                <Button onClick={() => updateWarehouseManagerProfile()}>Save</Button>
...
export default WarehouseManagerProfile;