...
const EmployeeSupervisorProfile = ({openSnackbar}) => {
    ...
    const updateEmployeeSupervisorProfile = async () => {
        try {
            if (ValidationService.validateMiddleName(middleName) && ValidationService.validateEmail(email) && ValidationService.validateSkype(skype), ValidationService.validatePosition(position)) {
                await APIService.updateEmployeeSupervisor(accessToken, user.id, middleName, email, skype, birthday, phone, position, gender);
                    ...
                    <Grid className={classes.profileContainer}>
                        {!edit ? (
                            ...
                            <Grid container direction={"column"} className={classes.root}>
                                ...
                                <Button onClick={() => updateEmployeeSupervisorProfile()}>Save</Button>
...
export default EmployeeSupervisorProfile;